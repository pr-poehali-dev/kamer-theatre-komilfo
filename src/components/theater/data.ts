...
export const performances = [
  {
    ...
    image: 'https://cdn.poehali.dev/files/db1f1ef4-c81a-4806-870e-9e2e3ac26fa5.jpg',
...
Приходите посмотреть, как случайные соседи становятся командой, раскрывают свои мечты из детских писем и встречают Новый год в самой необычной компании!`,
  ...
  },
  {
    ...
    description: 'Фантастическая история о памяти и патриотизме',
...
export const newsItems: News[] = [
  {
    id: '1',
    title: 'Театр «Комильфо» стал победителем грантового конкурса!',
    date: '2026-01-13',
    image: 'https://cdn.poehali.dev/files/20250520_094037.jpg',
    content: `Друзья, у нас радостная новость! 🎉

Наш театр «Комильфо» стал победителем грантового конкурса Президентского фонда культурных инициатив 2026 года!

Наш проект «ОЖИВШАЯ ИСТОРИЯ: театральный тур по местам боевой славы 46-го авиационного женского полка» вошел в число 810 лучших инициатив со всей России.

Для нас это большая честь и высокая степень ответственности!

В рамках проекта мы в 2026 году организуем выезды в регионы края с показом спектакля «Безымянная карточка», посвященного Великой Победе в 1941-1945 гг. и героическому подвигу женщин-ветеранов ВОВ, воевавших в разных родах войск, в том числе летчиц гвардейского авиационного полка «ночных ведьм», который базировался у нас в крае во время освобождения Кубани и Таманского полуострова.

Именно поэтому мы выбрали выезды в эти регионы края:
🎖️ Станица Ивановская — здесь женскому авиационному полку было вручено знамя и присвоено звание Гвардейского.
🎖️ Поселок Пересыпь, Новороссийск и Крымск — в этих местах полк базировался в период воздушных боев на «Голубой линии».
...
Мы уверены, что наша команда сможет ярко и качественно воплотить задуманное в жизнь, а наш патриотический проект будет тепло встречен жителями Кубани.`,
    tags: ['ФондКультурныхИнициатив', 'ЯПобедительПФКИ', 'театрКомильфо', 'ВеликаяПобеда', 'ПамятьПоколений'],
    isVisible: true,
  },
];
...
export const reviews = [
  {
    name: 'Ирина Тарахтиенко',
    text: 'Шикарный спектакль, была на нём - есть, где посмеяться, и есть, где поплакать. Понимаешь, через какие трудности пришлось пройти нашим предкам, их истории будоражили весь спектакль. На этот спектакль можно смело идти всей семьей, и начать или продолжить знакомить детей со своими предками, с их героизмом и той человечностью, которые с каждым годом забываются всё больше и больше.',
    performance: 'Безымянная карточка',
    rating: 5,
  },
  {
    name: 'Артём Краснокутский',
    text: 'Спектакль "Безымянная карточка" оставил неизгладимый след в душе. Это пронзительная история о связи поколений, силе памяти и самопознании, которая трогает до слёз. Постановка сочетает в себе элементы фантастики, драмы и лирики, создавая мощный эмоциональный резонанс. Особенно хочется отметить великолепную игру всего актерского состава! Браво!!!',
    performance: 'Безымянная карточка',
    rating: 5,
  },
  {
    name: 'Ольга Полянская',
    text: 'Невероятная постановка талантливыми людьми. Каждая ваша работа трогает до глубины души, приходит переосмысление многих моментов жизни, ценностей, смыслов, целей... Огромная благодарность за ваш труд, вашу деятельность, энтузиазм, любовь к искусству и своему делу, расширение моего кругозора! Благодарю!',
    performance: 'Безымянная карточка',
    rating: 5,
  },
  {
    name: 'Анна Петрова',
    text: 'Потрясающая атмосфера! Спектакль "Безымянная карточка" тронул до слёз. Актёры играют от души, чувствуется каждая эмоция. Обязательно приду ещё!',
    performance: 'Безымянная карточка',
    rating: 5,
  },
  {
    name: 'Дмитрий Соколов',
    text: 'Отличный камерный театр! Были на "Вечернем турне" — смеялись всем залом. Очень уютная атмосфера, чувствуешь себя частью действия.',
    performance: 'Вечернее турне',
    rating: 5,
  },
  {
    name: 'Елена Михайлова',
    text: 'Современный микс сказки и комедийной истории на площадке телекомпании "Бред ТВ"! Очень динамично, но при этом трогательно. Понравилось, как переплетаются юмор и искренние эмоции!',
    performance: 'КраШная шапочка',
    rating: 5,
  },
  {
    name: 'Сергей Иванов',
    text: 'Театр "для своих" — это точно про Комильфо! Маленький зал, но какая игра актёров! "Городские истории" зацепили за живое. Рекомендую всем!',
    performance: 'Городские истории',
    rating: 5,
  },
  {
    name: 'Мария Волкова',
    text: 'Была на нескольких спектаклях — каждый раз получаю огромное удовольствие. Актёры талантливые, постановки качественные. Это настоящий театр!',
    performance: 'Общий отзыв',
    rating: 5,
  },
  {
    name: 'Ольга Смирнова',
    text: 'Ходим с мужем регулярно. "Тайна Кафе Ромашка" — отличная детективная комедия, отдохнули душой. Атмосфера семейная.',
    performance: 'Тайна "Кафе Ромашка"',
    rating: 5,
  },
];