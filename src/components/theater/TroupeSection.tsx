  ...
  return (
    <div className="py-12 animate-fade-in">
      <div className="container mx-auto px-4">
        <h2 className="text-6xl font-bold text-center mb-8 animate-fade-in-up">Наша труппа</h2>
          ...
          <Card className="bg-card border-border overflow-hidden hover:shadow-xl transition-shadow animate-scale-in">
            <div className="md:flex md:flex-row">
              ...
              <CardContent className="p-6 md:w-3/5 flex flex-col justify-center">
                <h3 className="text-4xl font-bold mb-2">Светлана Кузикова</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="bg-card border-border overflow-hidden hover:shadow-xl transition-shadow animate-scale-in delay-400">
            <img
              src="https://cdn.poehali.dev/projects/b938984c-0d60-47c5-a439-7d0d401d3bf4/bucket/b9432ef2-81a5-46d8-a158-8355fe0ad870.jpg"
              alt="Елена Соболева"
              className="w-full h-80 object-cover object-top"
            />
            <CardContent className="p-6">
          ...
          <Card className="bg-card border-border overflow-hidden hover:shadow-xl transition-shadow animate-scale-in delay-600">
            <img
              src="https://cdn.poehali.dev/projects/b938984c-0d60-47c5-a439-7d0d401d3bf4/bucket/43a7762e-c384-465d-9546-1d72f9d2698b.jpg"
              alt="Марина Лапанина"
              className="w-full h-80 object-cover object-top"
            />
            <CardContent className="p-6">
