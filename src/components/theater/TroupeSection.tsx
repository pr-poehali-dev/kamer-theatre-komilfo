      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="bg-card border-border overflow-hidden hover:shadow-xl transition-shadow animate-scale-in delay-300">
            <img
              src="https://cdn.poehali.dev/projects/b938984c-0d60-47c5-a439-7d0d401d3bf4/bucket/a00d4be1-c27a-450e-bc8f-61ddc4ed3632.jpg"
              alt="Елена Короткова"
              className="w-full h-80 object-cover object-top"
            />
            <CardContent className="p-6">
          ...
          <Card className="bg-card border-border overflow-hidden hover:shadow-xl transition-shadow animate-scale-in delay-500">
            <img
              src="https://cdn.poehali.dev/projects/b938984c-0d60-47c5-a439-7d0d401d3bf4/bucket/a2302116-98f1-423d-8094-ddbf18abeaa3.jpg"
              alt="Анна Котышева"
              className="w-full h-80 object-cover object-top"
            />
            <CardContent className="p-6">
