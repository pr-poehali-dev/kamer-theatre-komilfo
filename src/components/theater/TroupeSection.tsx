      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="bg-card border-border overflow-hidden hover:shadow-xl transition-shadow animate-scale-in delay-300">
            <img
              src="https://cdn.poehali.dev/projects/b938984c-0d60-47c5-a439-7d0d401d3bf4/bucket/f632e0ea-6bf1-4e19-a782-e95cd8b74ef0.jpg"
              alt="Елена Короткова"
              className="w-full h-80 object-cover object-top"
            />
            <CardContent className="p-6">
          ...
          <Card className="bg-card border-border overflow-hidden hover:shadow-xl transition-shadow animate-scale-in delay-700">
            <img
              src="https://cdn.poehali.dev/projects/b938984c-0d60-47c5-a439-7d0d401d3bf4/bucket/50678fe6-8ba0-4c46-bd8c-c8926105ee17.jpg"
